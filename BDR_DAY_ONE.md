# SUMMIT: your first day

SUMMIT builds your call list for the day, writes a prep script for every
contact, and records what happened on each call straight into HubSpot.

**Link:** https://summit-production-a582.up.railway.app

Antonio gives you the password. There is no username. One password, one link,
nothing to install.
...
Open the link. Type the password. Press "Start the climb".
...
Every logged call moves the climber up the trail. Clear the list and you reach
the summit.
...
|---|---|
| Connected, interested | You spoke to them and they want to keep talking |
| Connected, not interested | You spoke to them and they said no |
| Connected, callback | You spoke to them and they asked you to call back |
| Voicemail | You left a message |
| No answer | Nobody picked up |
| Busy | The line was busy |
| Wrong number | The number is not theirs |
| Gatekeeper | You reached a receptionist or assistant, not the person |
